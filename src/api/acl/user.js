...
//     })
// }
export const login = ({ username, password }) => request({ url: '/admin/acl/index/login', method: 'post', data: { username, password } })
    /*
    获取用户信息(根据token)
    */
    ...
    //     })
    // }
export const getInfo = () => request({ url: '/admin/acl/index/info', method: 'get' })
    /*
    登出
    */
...
// }
export const getMenu = () => request({ url: '/admin/acl/index/menu', method: 'get' })
