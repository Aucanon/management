...
export const reqSave = () => request({ url: '/admin/product/saveSkuInfo', method: 'post' })
...
export const reqDelete = (skuId) => request({ url: `/admin/product/deleteSku/${skuId}`, method: 'delete' })